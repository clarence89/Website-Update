...
if (isset($_POST['submit_approval'])) {
    ...
    $sql = "UPDATE website_update SET status='$status', reason='$reason' WHERE website_update_id='$update_id'";
    $db->query($sql);
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "</td>";
                                echo "<td><a target='_blank' href='generate_print.php?id=" . $row['website_update_id'] . "&filename=" . urlencode($row['title']) . ".docx'>Print</a></td>";
                                echo "<td>";
                                ...
                                if ($row['status'] == 0) {
                                    ...
                                    echo "<button type='submit' name='submit_cancel' class='btn btn-danger'>Cancel</button>";
                                    echo "</form>";
                                } else {
                                    echo "N/A";
                                }
